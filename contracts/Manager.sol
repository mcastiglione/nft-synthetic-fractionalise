...
contract Manager {
  ...
  */
  constructor(
    ...
    address _syntheticNftAddress = ERC721TokenFactory.deployERC721(address(this), _name, _symbol, _governanceAddress);
  ...
  */
  function setNftInVault(address nftAddress, uint256 nftId, address previousOrNewOwner, bool received) public onlyOracle {
    // do something
  }

  function isPreviousOwner(address nftAddress, uint256 nftId, address caller) public view returns (bool) {
    return true;
  }
  ...
  * @param tokenId the token ID
  */
  function getTokenId(address nftAddress, uint256 tokenId) public view returns (uint) {
