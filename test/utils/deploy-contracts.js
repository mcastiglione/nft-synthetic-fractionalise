...
async function deployContracts() {
  ...
  // Deploy Governance Data
  const GovernanceData = await ethers.getContractFactory("GovernanceData");
  const GovernanceDataDeploy = await GovernanceData.deploy(14400, 7884000, 5);
